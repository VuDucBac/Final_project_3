...
video = cv2.VideoCapture("/home/cv/Desktop/Final_Project-main/video/Traffic_light.mp4")
detectorr = YoloX()
...
def ProcessTracking(video, detector, tracker, deep=False, skip_frame=1):
    ...
    while True:
        ...
        if(frame_id % skip_frame == 0):
            ...
            object_counter.Color_detector(frame)
...
class MainWindow(QMainWindow):
    ...
    def Create_Line(self):
        ...
        vidcap = cv2.VideoCapture("/home/cv/Desktop/Final_Project-main/video/Traffic_light.mp4")
        _, frame = vidcap.read()
        object_counter.Set_line(frame_id,frame)
        ###
        frame_id+=1
